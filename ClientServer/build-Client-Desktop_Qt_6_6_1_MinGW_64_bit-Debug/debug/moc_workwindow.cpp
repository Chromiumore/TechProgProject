...
static constexpr auto qt_meta_stringdata_CLASSWorkWindowENDCLASS = QtMocHelpers::stringData(
    "WorkWindow",
    "toAuth",
    "",
    "on_backToAuthButton_clicked"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSWorkWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSWorkWindowENDCLASS_t qt_meta_stringdata_CLASSWorkWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "WorkWindow"
        QT_MOC_LITERAL(11, 6),  // "toAuth"
        QT_MOC_LITERAL(18, 0),  // ""
        QT_MOC_LITERAL(19, 27)   // "on_backToAuthButton_clicked"
    },
    "WorkWindow",
    "toAuth",
    "",
...
Q_CONSTINIT const QMetaObject WorkWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSWorkWindowENDCLASS_t,
        ...
        // method 'on_backToAuthButton_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void WorkWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->toAuth(); break;
        case 1: _t->on_backToAuthButton_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (WorkWindow::*)();
            if (_t _q_method = &WorkWindow::toAuth; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
